 ...
 */
export async function initKeyframeBridge(scene, config) {
    if (!config.enabled) {
 ...
 */
export function solvePoses(scene, timeSec, solveKinematicsFallback) {
    // 始终先用内置运动学计算基线位姿
 ...
 * 销毁桥接器
 */
export function disposeKeyframeBridge() {
 ...
 * 检查桥接器是否处于活动状态
 */
export function isKeyframeBridgeActive() {
